...
|[`type_alias_impl_trait`](https://github.com/rust-lang/rust/issues/63063)|Eliminate boxing of `Future`s in some static-dispatch methods of `SignalCellPin` implementations.|
